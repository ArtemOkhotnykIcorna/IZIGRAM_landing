      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.download}>
            ...
            <div className={styles.downloadButtons}>
              <a href="#timer-modal" className={`${styles.storeButton} open-modal`} target="_blank">
                App Store
                <svg viewBox="0 0 20 20">
        ...
        <div className={`${styles.info} fw-500 text-color-gray-350`}>
          <div className={styles.contacts}>
            <p>
              <a href="mailto:sales@izigram.com" className="text-color-gray-300">
                sales@izigram.com
              </a>
              {' '}(For partners and offers)
            </p>
            <p>
              <a href="mailto:ceo@izigram.com" className="text-color-gray-300">
                ceo@izigram.com
              </a>
              {' '}(CEO - creator)
            </p>
